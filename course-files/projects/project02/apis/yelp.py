...
def get_categories():
    """
    Returns a list of valid yelp categories which are strings. Note that while this function
    returns SOME of the valid yelp categories, there's a lot more. They are 
