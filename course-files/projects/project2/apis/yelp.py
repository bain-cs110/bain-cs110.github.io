VERSION = 2026.2 # add is_closed to simplified restaurant
...
def get_categories():
    ...
    [documented on Yelp's website](https://blog.Yelp.com/businesses/Yelp_category_list) \
...
def _issue_get_request(url:str, debug: bool = True):
    ...
    * url (str): [Required] The API Endpoint + query parameters.
    ...
    if response.status_code in [401, 403]:
        print("Authorization error - can try backup")
