...
def interpolate_colors(color1, color2, frac):
    ...
    Returns:
        str: A color (as a hex string) to be used elsewhere
   """
    if "#" not in color1:
...
def polygon(points=[], color="hotpink", **kwargs):
    ...
    Args:
        points (list, optional): The points outlining the polygon; this should be a list of tuples (coordinates).
            defaults to an empty list.
        color (str, optional): What color to make the shape. Defaults to `"hotpink"`
