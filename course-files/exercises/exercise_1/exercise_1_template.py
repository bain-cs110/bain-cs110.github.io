...
# Just make sure that the drawing is made with turtle_5 otherwise
# the autograder won't see it!


## DATA SECTION #####!!!#####

## For this section, be VERY CAREFUL to save the requested data in the appropriate 
##   variable name.
