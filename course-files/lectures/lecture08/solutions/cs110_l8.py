...
import math     
def oval(center_x, center_y, radius_x, radius_y, color="hot pink"):
    """
...
def rectangle(center_x, center_y, width, height, color="hot pink", **kwargs):
    """
    ...
    """
    point_0 = (center_x - width / 2, center_y - height / 2)
    point_1 = (center_x + width / 2, center_y - height / 2)
    point_2 = (center_x + width / 2, center_y + height / 2)
    point_3 = (center_x - width / 2, center_y + height / 2)
