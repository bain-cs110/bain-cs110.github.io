...
def main_menu():
    gui.show_text("I'm thinking of a number between 1 and 100...")
    gui.show_text("Your current guess is:", brain['current_guess'], append=True)
...
def enter_a_guess():
    user_input = gui.popup_input("Please enter a guess (number between 0 and 100)!")
...
def cheat():
    ...
    gui.show_text("The number I'm thinking of is between", lower_num, "and", higher_num, ".", append=True)
