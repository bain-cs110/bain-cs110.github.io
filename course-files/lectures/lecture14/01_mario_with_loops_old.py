...
_ignore = setup_shapes('Lecture 14', background="white", grid=True, width=900, height=800)

########################## YOUR CODE BELOW THIS LINE ##############################

## This is a helper function that helps us calculate the right x and y coordinates
