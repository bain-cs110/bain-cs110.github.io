...
## Example 10: And of course, you can use lists as inputs to functions
## and even as return values!

todo_list = ["Start HW3", "Study for Quiz", "Enjoy Prof. Bain's jokes"]
print("Old:", todo_list)
# Name: check_off_list
# Input:
# 1. a_list (list): required input of a list of strings
def modify_todo(a_list):
    a_list[0] = "Finish HW3"  # remove the first item of the list
    return a_list

new_todo = modify_todo(todo_list)
print("New:", new_todo)