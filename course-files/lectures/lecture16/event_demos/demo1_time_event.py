...
def make_square_face(a_canvas, center, width, my_tag=""):
    ...
    center_x = center[0]
    center_y = center[1]
    p1_utilities.make_square(a_canvas, (center_x - width / 2,
       center_y - width / 2), width, fill_color="green", tag=my_tag)
    p1_utilities.make_square(a_canvas, (center_x - width / 3, center_y - width / 6),
       big_square_width / 6, fill_color="purple", tag=my_tag)  # left eye
    p1_utilities.make_square(a_canvas, (center_x + width / 6, center_y - width / 6),
       big_square_width / 6, fill_color="white", tag=my_tag)  # right eye
    p1_utilities.make_square(a_canvas, (center_x - width / 60, center_y +
...
time.sleep(5)
p1_utilities.update_fill(the_canvas, 'test_creature', color='yellow')
