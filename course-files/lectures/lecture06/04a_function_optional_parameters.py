...
# function calls:
draw_diamond(50, "blue")  # have to give both inputs


# function definition with 1 required parameter and 1 optional/keyword:
def draw_diamond_color(side_length, color="green"):
    change_pen_color(shelly, color)
    left_turn(shelly, 45)
    forward(shelly, side_length)
    left_turn(shelly, 90)
...
draw_diamond_color(100)  # Don't use the optional parameter
draw_diamond_color(150, color="red")  # Use the optional parameter
draw_diamond_color(200, color="purple")
