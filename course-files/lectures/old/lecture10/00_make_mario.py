...
def make_square(a_canvas, origin, width, color="white"):
...
def make_mario(the_canvas, bottom_left, pixel=25, clothes="red", overalls="blue"):
    origin = bottom_left
    # row 14
    # blank, pixel (0,14)
    # blank, pixel (1,14)
...
color_palette = ['purple', 'blue', 'red', 'violet', 'grey']
