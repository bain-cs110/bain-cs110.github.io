...
def print_data_and_type(description, data):
    print('{} ({}):\n{}\n'.format(description, type(data), data))

def search_for_video(search_term):
    """
    Function to search for a given video on Youtube.

    Parameters:
      * search_term (str): the string that reprents what to search for
    ...
    function_url = 'https://www.apitutor.org/youtube/simple/'
...
search_results = search_for_video("dogs skateboarding")
