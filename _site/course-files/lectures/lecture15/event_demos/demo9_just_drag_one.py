...
def move_circle(event):
    ...
    width = project_utilities.get_width(the_canvas, active_tag)
    height = project_utilities.get_height(the_canvas, active_tag)
    left = project_utilities.get_left(the_canvas, active_tag)
    top = project_utilities.get_top(the_canvas, active_tag)
