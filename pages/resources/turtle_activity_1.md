...
In this simulation, you only had three <strong>commands</strong>. In other words, the computer only understood these three actions of turning left, turning right, and going forward. But say we wanted the turtle to go backwards one square. Is there any way we could <em>combine</em> these three commands into a BACKWARDS command? In the space below, type a sequence of button presses you might use to go <strong>backwards</strong>!

[Next turtle activity...](/resources/turtle-activity-1)
