...
<style>
   ...
   ul.profiles li img {object-position: 0 0; object-fit: cover; margin:0 auto; padding:10px 10px 0 10px; width:275px; height:327500px; opacity:0.9;}
   ...
   ul.profiles li:hover h3 {opacity:1.0;}
   ul.profiles h4 {margin:5px 0 0 0; padding:0px 0 0 0; color:#000; opacity:0.4; font-size:16px;}
