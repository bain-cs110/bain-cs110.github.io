...
> **Important**: in order for the shapes that constitute your creature to “belong” together, each shape has to be tagged.
...
## Part 5. Create a short video (2 points)
Please create a short (like ~15 seconds) video of your terrarium / aquarium in action. To do this:
1. Take a screencast. The easiest way is to just open a Zoom meeting, share your screen, and hit record. (If you need help with this, make sure to come to office hours)
1. Submit it to the SEPARATE CANVAS ASSIGNMENT
1. Share your video so that anyone with link can view.

## Reference Materials
### Code Samples
There are lots of samples/demos of how to include user interaction in our [Lesson 15](../lectures/week06-lecture03) lecture files. There are also some advanced animation techniques in there for you to use as a reference.
