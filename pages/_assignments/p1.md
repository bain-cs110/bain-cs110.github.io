...
> **Important**: in order for the shapes that constitute your creature to “belong” together, each shape has to be tagged. When modifying your HW 3 creature, strongly consider replacing your various `make_shape` functions with their counterparts in `utilities.py` (those functions are setup to create the correct tags) .
