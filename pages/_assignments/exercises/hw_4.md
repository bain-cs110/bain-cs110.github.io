...
<a class="nu-button" href="{{site.url}}/course-files/homeworks/hw04_template.py" target="_blank">
    Homework Starter File <i class="fas fa-download"></i>
</a>

<br>

<a class="nu-button" href="{{site.url}}/course-files/homeworks/hw04_utilities.py" target="_blank">
...
<img class="frame center med-lg" src="{{site.url}}/assets/images/project01/grid.svg" />
