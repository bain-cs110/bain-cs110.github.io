...
Next we'll focus on some numerical programming toward the bottom of the `hw01.py` file.
...
(The answer is roughly 0.1017). **Don't forget to print the result of the calculation even if you store it in a variable.**
