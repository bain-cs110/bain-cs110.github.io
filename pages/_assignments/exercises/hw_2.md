...
<details>
  ...
  2. On line 5, change the value of the `background` input to `"black"`.
</details>
<br>
...
## Task 3. Create a `bullsye` function
...
> **Note:** You MUST use your `circle` and `oval` functions to complete this one. Why do all that work again? The eyes need to scale with the width of the face. Their **radius in the x-direction** should be 1/20 the `width` of the face. Their **radius in the y-direction** should be 1/18 the width of the face. They should be offset by 1/7 the width of the face from the center of the face in both the x and y-directions (remeber, the y-axis is flipped!).
