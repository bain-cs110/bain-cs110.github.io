...
In this homework assignment, you'll be moving from making "static" pictures like in HW2 and HW3, to making live animations!
...
A peer mentor from a previous year, Katherine, has created a helpful <a href="https://www.youtube.com/watch?v=RftT-A5vzH8&feature=youtu.be" target="_blank">how to get started video</a> to get you oriented with the assignment.
...
1. Use a loop
1. Use the random module, and in particular the [random.uniform](https://docs.python.org/3/library/random.html#random.uniform) function to give each star (or bubble if you choose) a random (x, y) position (given the dimensions of the screen) and a random width (so that it renders stars of different sizes).
...
> **IMPORTANT**: YOU MUST TURN IN THE FILES — BOTH THE  ZIP FILE AND THE PYTHON FILES — NAMED EXACTLY AS SPECIFIED ABOVE.
