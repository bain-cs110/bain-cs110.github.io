...
Please sign-up for a tutorial using <a class="lab" href="https://docs.google.com/spreadsheets/d/1n9io9LSvSR_IolYRnwMluJ2Eq_qFN7uhGFRBMQVzvec/edit?usp=sharing" target="_blank">THIS SIGN-UP SHEET <i class="fa fa-link" aria-hidden="true"></i></a>. This spreadsheet will be made editable during lecture on Wednesday (1/05).

> * There should be roughly 13 students per tutorial (give or take).
