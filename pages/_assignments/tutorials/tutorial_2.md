...
<a class="nu-button" href="{{site.url}}/course-files/tutorials/tutorial02/your_task.py" target="_blank">
...
<img class="medium frame" src="{{site.url}}/assets/images/tutorials/mario1.png" />
...
<img class="medium frame" src="{{site.url}}/assets/images/tutorials/find.png" />
...
<img class="medium frame" src="{{site.url}}/assets/images/tutorials/replace.png" />
...
<img class="medium frame" src="{{site.url}}/assets/images/tutorials/marios.png" />
