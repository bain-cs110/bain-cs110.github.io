...
Animate the creatures in your landscape by picking **five** of the following effects to implement (note: you cannot double count one piece of code for multiple features):

{:.rubric-short}
| | Points | Task |
|--|--|--|
| 1 | 3 points | Animate at least two of your creatures (and your environmental features if it makes sense to do so). If creatures / environmental features move off of the screen, recreate them on the other side or have them bounce off the side. |
...
| 5 | 3 points | Periodically (repeatedly) add or remove creatures and/or landscape objects to/from your scene. |
...
| 7 | 3 points | Detect creature collisions and do something interesting _inside of your animation_ if creatures collide |
| 8 | 3 points | Enable the user to reposition a creature or landscape feature by dragging it |
| 9 | 3 points | Experiment with different kinds of motion. Instead of your creatures moving linearly at a constant speed, you can experiment with the math.sin and math.cos functions (or any others techniques) to make your creature oscillate, accelerate, decelerate, etc. |
| 10 | 3 points | Create some game mechanics (space bar jumps or shoots, drag ‘flings’ an object, etc.). |
| 11 | 3 points | Make your creature animate with different versions like Mario in Tutorial 4. |
