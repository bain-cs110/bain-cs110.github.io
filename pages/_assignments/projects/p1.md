...
> **Note:** Reminder, using code from **any** source, outside of the examples I provide in class and on edSTEM, that you did not write yourself is explictly forbidden on our course syllabus. We reserve the right to audit your project via an interview with you. If there is any part of your program you cannot explain, it will be considered a violation of NU'S Academic Integrity policy and you will receive an automatic 0 on the project.

* * *

## Part 1: Create a make_creature function
Create a custom function called `make_creature` that makes a creature of your choosing. Feel free to use/modify/improve upon the function you already made in [HW4](hw-4)!.
