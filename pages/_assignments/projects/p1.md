...
## Part 2: Create a <code>landscape_object</code> function

You have already experimented with clouds in Homework 5. Here, you will make an object of your own choosing (e.g. a tree, a building, a rock, grass, coral, etc.). To do this, you will create a custom function called `landscape_object` that draws a landscape feature of your choosing. It should be made up of at least 5 shapes. It should have at least 4 parameters that enable the calling function to specify arguments for:
...
There are lots of samples/demos of how to include user interaction in our Lecture 13/14 files. There are also some advanced animation techniques in there for you to use as a reference.
