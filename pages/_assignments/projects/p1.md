...
We've been taking care of this for you with some magic in the templates you've started with...but we're removing that scaffold for this project. **Luckily**, fixing things for this is relatively easy! For instance, in your `make_creature` function you'll use from HW4, you'll (**as a human**) just need "run" the following algorithm:
...
for shape in each_of_your_shapes:
    ...
    if it is:
        change the offset from positive to negative (or vice versa)
    else:
        leave it alone
```
...
Once you've fixed your function...you're good to go! However, while you're doing you animations keep in mind that the y-axis is flipped. To go up, you DECREASE the y-value and to go down you INCREASE the y-value.

* * *

## Part 1: Create a make_creature function
Create a custom function called `make_creature` that makes a creature of your choosing. Feel free to use/modify/improve upon the function you already made in [HW4](hw4)!.
...
| 4 | 3 points | Animate _each_ of your creatures so that their movement is different (different speeds AND different movement patterns). |
...
The `project_utilities` file you have access to is documented here:

<a class="nu-button" href="/course-files/projects/project01/docs/project_utilities.html" target="_blank">
...
## What to Turn In
1. Your project file to the Project 1 CODE Canvas assignment. **MAKE SURE TO INCLUDE THE PARAGRAPH THAT EXPLAINS WHICH ANIMATION OPTIONS YOU IMPLEMENTED AS DESCRIBED in Part 4 above.**
        ...
        <tr>
            ...
            <td>
                <ul>
                    ...
                    <li>Does not use libraries other than the provided project_utilities library.</li>
                </ul>
            </td>
        </tr>
        <tr>
...
<a class="nu-button" href="/course-files/projects/project01/project_1_main_template.py" target="_blank">
    Project Starter File <i class="fas fa-download"></i>
</a>

<br>

<a class="nu-button" href="/course-files/projects/project01/project_utilities.py" target="_blank">
