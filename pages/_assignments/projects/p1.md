...
for shape in each_of_your_shapes:
    look to see if the y-coordinate is being shifted from the center or corner 
    if it is:
...
I demoed this in class during Lecture 15. Once you've fixed your function...you're good to go! However, while you're doing you animations keep in mind that the y-axis is flipped. To go up, you DECREASE the y-value and to go down you INCREASE the y-value.
...
| 4 | 3 points | Animate each of your creatures so that their movement is different (different speeds AND different movement patterns). |
