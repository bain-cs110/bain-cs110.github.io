...
<table style="width:40%; padding;5px; border:0px;">
  <tr>
...
<iframe src="https://northwestern.hosted.panopto.com/Panopto/Pages/Embed.aspx?id=bc061d97-b670-44cd-b847-b17a0016f533&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=true&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="p2_yelp_demo" ></iframe>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ul>
                    <li>Displays the user's selected categories(s) on the main menu</li>
                    <li>Displays the available Yelp categories from which to choose in either the Textbox or Popup Window.</li>
        ...
        <tr>
            ...
            <td>
                <ul>
                    ...
                    <li>Displays the selected ordering criteria on the main menu</li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <ul>
                    ...
                    <li>Shows the matching restaurants to the GUI textbox in some coherent format</li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <ul>
                    <li>Allows user to preview an individual restaurant via the GUI Textbox</li>
