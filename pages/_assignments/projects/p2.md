...
test_can_send_email (tests.test_twilio.TestTwilio.test_can_send_email) ... Please enter your email address: some.address@gmail.com
Email sent. You may need to check your spam folder.
ok

----------------------------------------------------------------------
Ran 7 tests in 8.441s
...
**The most common error** you may get from the above, particularly if you're on a Mac is a security (SSL) error. To fix this, please open your finder and navigate to your `Applications > Python 3.11` folder (or whichever python version you have installed). Then, double-click on the `Install Certificates.command` file. Then re-run the verification test and you should receive an email to whatever address you enter.
