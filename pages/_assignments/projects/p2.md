...
> **NOTE:** The `spotify.get_similar_tracks()` function’s job is to get recommendations based on seed data. It has very specific requirements about what inputs it needs to work.
