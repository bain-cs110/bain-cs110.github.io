...
1. Retrieve the restaurants, and allow the user to specify an additional keyword (a search term to be used with the `get_businesses` function) before executing the search.
...
Please note that the official deadline for the project is the day of our final exam block. **No late submissions will be accepted. If you don't turn it in by this deadline you will receive a 0 no matter what.**
<br>
