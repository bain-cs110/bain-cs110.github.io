...
<ul class = "profiles">
    ...
    <li><a><img alt="picture of Andres" src="{{site.url}}/assets/images/directory/andres.jpg">
    ...
    <li><a><img alt="picture of David" src="{{site.url}}/assets/images/directory/david.jpg">
        <span><h3>David Xu</h3><h4>Peer Mentor</h4></span>
    </a></li>
    <li><a><img alt="picture of Defne" src="{{site.url}}/assets/images/directory/defne.jpg">
        <span><h3>Defne Deda</h3><h4>Peer Mentor</h4></span>
    </a></li>
    <li><a><img alt="picture of Gerardo" src="{{site.url}}/assets/images/directory/gerardo.jpg">
        <span><h3>Gerardo Perez</h3><h4>Peer Mentor</h4></span>
    </a></li>
    <li><a><img alt="picture of Guo" src="{{site.url}}/assets/images/directory/guo.jpg">
        <span><h3>Guo Ye</h3><h4>Graduate TA</h4></span>
    </a></li>
    ...
    <li><a><img alt="picture of Maddie" src="{{site.url}}/assets/images/directory/maddie.jpg">
        <span><h3>Maddie Brucker</h3><h4>Graduate TA</h4></span>
    </a></li>
    <li><a><img alt="picture of Nicole" src="{{site.url}}/assets/images/directory/nicole.jpg">
