...
You can join our edSTEM page (which we use for Q&As as well as post tips/tricks throughout the quarter) by [signing up **using your offical Northwestern email address**](https://edstem.org/us/join/RFndss).
