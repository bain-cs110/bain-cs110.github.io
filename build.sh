...
# HW 6 Docs
pdoc --show-source course-files/homeworks/hw7/wordle.py -o course-files/homeworks/hw7/docs
pdoc --show-source course-files/homeworks/hw7/hw7_utilities.py -o course-files/homeworks/hw7/docs
